...
//     document.getElementById('about').style.color='#268184';
//     document.getElementById('about').style.borderBottom='2px solid #268184';
...
// Home inside About Us Page
// let homeInside = document.querySelector('#home');

// homeInside.addEventListener('click', ()=>{
